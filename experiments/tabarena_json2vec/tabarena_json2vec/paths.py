...
TABARENA_REPO = TABARENA_ROOT / "tabarena"
METADATA_PATH = TABARENA_REPO / "tabarena" / "nips2025_utils" / "metadata" / "task_metadata_tabarena51.csv"
...
def configure_import_paths() -> None:
    ...
    if TABARENA_REPO.exists():
        sys.path.insert(0, str(TABARENA_REPO))
